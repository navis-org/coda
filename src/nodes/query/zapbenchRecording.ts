/**
 * ZapBench Recording: the whole population's activity, which a selection of cells is made from.
 *
 * `ZapBench Traces` starts from neurons and asks for their traces. This starts from the recording
 ...
 * typed, at full resolution, through the selective reader `ZapBench Traces` uses. Scale is offered
...
registerNode({
  type: 'zapbench.recording',
  label: 'ZapBench Recording',
  category: 'query',
  cardWidth: 300,
  description:
