...
export const exploreNode = registerNode({
  ...
  params: [
    ...
    },
    {
      ...
      label: 'Selected',
      noun: 'neurons',
      help: 'Neurons ticked in the list. Kept when the search changes. Saved into the workflow.',
      default: [],
    },
    {
      /*
    ...
    },
    {
      ...
      help: 'A column of free-form tags per neuron, joined with "; ". Drawn as its own muted row.',
      default: '',
      optional: true,
      advanced: true,
    },
    {
      ...
      kind: 'boolean',
      label: 'Search tags',
      help: 'Whether the search box matches tag text. A field term naming the column works either way.',
      default: true,
      advanced: true,
