/**
 * Neurons to ZapBench Traces: the calcium-imaging trace of every neuron in a fish2 table that has one.
 *
 ...
 * `noSuchCondition` in `packs/zapbench/cells.ts`, shared with ZapBench Traces.
 *
...
export const neuronTracesNode = packNode({
  type: 'zapbench:neuronTraces',
  // Built in until it moved into this pack; files saved before then name it so.
  formerTypes: ['zapbench.neuronTraces'],
  label: 'Neurons to ZapBench Traces',
  category: 'query',
  cardWidth: 300,
  description:
