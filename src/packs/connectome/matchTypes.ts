...
import { MAX_COMPARED_DATASETS } from '../../nodes/lib/edgeComparison'
import { repeatParamId, repeatParams } from '../../nodes/lib/repeatParams'
import type { LabelMode, MapperDataset } from '../../nodes/lib/typeMapping'
import {
  ...
  mapperReportTable,
  matchCellTypes,
} from '../../nodes/lib/typeMapping'

/** How many connectomes one mapping may span — shared with Compare Connectivity, see there. */
const MAX_DATASETS = MAX_COMPARED_DATASETS
 ...
 *
 * The registry reads the group's range off this object; so does the picker loop below. A bare
...
export const matchTypesNode = packNode({
  ...
  params: [
    ...
    ...typeColumnParams,
    {
      ...
      help: 'What a matched group is called. "Every name, joined" shows that two types were merged.',
      default: 'first',
