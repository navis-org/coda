...
import { basisOptions, totalsLookup } from '../../nodes/lib/connectivityOps'
import type { DenominatorLookup, PropagateResult } from '../../nodes/lib/influenceOps'
import {
  FRONTIER_BATCH,
  batched,
  combineHalves,
...
export const influenceNode = packNode({
