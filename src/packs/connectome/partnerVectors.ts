...
import {
  ...
  partnerVectorSchema,
  partnerVectorTable,
} from '../../nodes/lib/partnerVectors'
import type { PartnerBy, UntypedPolicy, VectorWeighting } from '../../nodes/lib/partnerVectors'
import { idColumn } from '../../nodes/lib/tableOps'
import { labelsByNeuron } from '../../nodes/lib/typeMapping'
import { ID_COLUMN_NAME } from '../../core/ids'

export const partnerVectorsNode = packNode({
