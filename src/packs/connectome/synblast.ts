...
import { SYMMETRY_OPTIONS, nblastMatrix } from '../../nodes/lib/nblastOps'
import {
  hasPolarity,
  synapseLabels,
  synapseSetFrom,
  synblastSidesFrom,
} from '../../nodes/lib/synblastOps'
import { labelColumnParam, warnAboveParam } from '../../nodes/lib/limitParams'
import { MAX_NEURONS } from '../../nodes/lib/limitParams'

export const synblastNode = packNode({
