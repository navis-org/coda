...
const RESERVED = new Set([
  ...
  'filter', 'select', 'arrange', 'mutate', 'summarise', 'summarize', 'rename',
  'group_by', 'slice', 'pull', 'count', 'union', 'intersect', 'setdiff', 'bind_rows',
  // Base functions a node label or port name maps onto.
  'c', 't', 'q', 'T', 'F', 'data', 'table', 'sort', 'sample', 'max', 'min', 'sum', 'mean',
  'range', 'rev', 'names', 'length', 'dim', 'list', 'matrix', 'vector', 'factor', 'levels',
  'rep', 'seq', 'paste', 'format', 'print', 'plot', 'merge', 'split', 'order', 'which',
  'nrow', 'ncol', 'head', 'tail', 'apply', 'lapply', 'sapply', 'do.call', 'Reduce',
