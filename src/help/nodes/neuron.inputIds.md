...
**Unwired**: the node emits the IDs as a one-column `Neurons` table.That is already enough for most of what a list of IDs is for: Connectivity, Skeletons, Meshes, Synapses and ROI Counts all need only the `neuronId` column.
