...
| ------------------------------------ | --------- | ---------------------------------------------------------------------------------------------------------------------------------------- |
| `cave/meshes.ts` `MESH_WARN_NEURONS` | 20        | A graphene mesh is ~492 requests and ~1.2 MB; no level of detail. Was a refusal — and twenty was never a scientific quantity of neurons. |
